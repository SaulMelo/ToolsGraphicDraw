...
public class InterpolatedCurve extends Bresenham {
    ...
    public int[] cubic(int[] P0, int[] P1, int[] P2, int[] P3) {   
        ...
        /*------------------ Firt Column --------------------------*/
        int C3x = (-4.5*P0[0])  + (13.5*P1[0])  + (-13.5*P2[0])  + (4.5*P3[0]); 
        int C2x = (9*P0[0])     + (-22.5*P1[0]) + (18*P2[0])     + (-4.5*P3[0]); 
        int C1x = (-5.5*P0[0])  + (9*P1[0])     + (-4.5*P2[0])   + (1*P3[0]); 
        int C0x = (1*P0[0])     + (0)           + (0)            + (0);   

        /*------------------ Second  Column -----------------------*/
        int C3y = (-4.5*P0[1])  + (13.5*P1[1])  + (-13.5*P2[1])  + (4.5*P3[1]); 
        int C2y = (9*P0[1])     + (-22.5*P1[1]) + (18*P2[1])     + (-4.5*P3[1]); 
        int C1y = (-5.5*P0[1])  + (9*P1[1])     + (-4.5*P2[1])   + (1*P3[1]); 
